...
| button                | 按钮相关配置，[详见下表](#button-attribute)                                                                                                           | <Enum type="object">{autoInsertSpace?: boolean}</Enum>                                                                                                                                                                                                                         | 详见下表                                                                               |
| message               | 消息相关配置， [详见下表](#message-attribute)                                                                                                         | <Enum type="object">{max?: number}</Enum>                                                                                                                                                                                                                                      | 详见下表                                                                               |
