...
export default function MaskTour() {
    ...
    return (
        <>
            ...
            >
                ...
                <ElTourStep
                    target={() => ref2.current?.ref.current}
                    title="Save"
                ...
                />
                <ElTourStep target={() => ref3.current?.ref.current} title="Other Actions" description="Click to see other" mask={false} />
            </ElTour>
        </>
    );
}
