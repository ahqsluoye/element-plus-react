...
export default () => (
    <svg width="280" height="180" viewBox="0 0 280 180" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="85.5" y="40.5" width="99" height="19" rx="1.5" fill="var(--el-fill-color-blank)" stroke="var(--el-color-primary)" />
        <g filter="url(#filter0_d_1544_8231)">
            <rect x="85" y="62" width="100" height="68" rx="2" fill="var(--el-bg-color-overlay)" />
            <rect x="84.7" y="61.7" width="100.6" height="68.6" rx="2.3" stroke="var(--el-border-color-dark)" strokeWidth="0.6" />
        </g>
        ...
        <defs>
            <filter id="filter0_d_1544_8231" x="81" y="59" width="108" height="76" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1544_8231" result="shape" />
            </filter>
        </defs>
    </svg>
);
