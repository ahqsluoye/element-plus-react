...
export default () => (
    <svg width="280" height="180" viewBox="0 0 280 180" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="96" y="89" width="84" height="8" rx="1" fill="var(--el-color-primary-light-8)" fillOpacity="0.6" />
        <rect x="96" y="103" width="84" height="8" rx="1" fill="var(--el-color-primary-light-8)" fillOpacity="0.45" />
        <g mask="url(#mask0_13239_209040)">
            <rect x="96" y="117" width="84" height="8" rx="1" fill="var(--el-color-primary-light-8)" fillOpacity="0.3" />
        </g>
        ...
        <defs>
            <filter id="filter0_d_13239_209040" x="80.3999" y="50.4004" width="119.2" height="79.1992" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
                ...
                <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_13239_209040" />
                <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_13239_209040" result="shape" />
            </filter>
        </defs>
    </svg>
);
