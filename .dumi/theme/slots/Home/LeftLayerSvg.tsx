...
function LeftLayerSvg({ className, style }: Props) {
    return (
        <svg className="left-layer-svg" width="262" height="173" viewBox="0 0 262 173" fill="none" xmlns="http://www.w3.org/2000/svg" style={style}>
            ...
            <defs>
                <clipPath id="clip0_11237_126796">
                    <rect width="261" height="172" fill="white" transform="translate(0.491211 0.941406)"></rect>
                </clipPath>
            </defs>
        </svg>
    );
