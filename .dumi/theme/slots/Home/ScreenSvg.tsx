...
function ScreenSvg({ style }: Props) {
    return (
        <svg className="screen-svg" style={style} width="1163" height="728" viewBox="0 0 1163 728" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="var(--screen-c-0)"
            ></path>
            <path d="M1152 0H8C3.58172 0 0 3.58172 0 8V64H1160V8C1160 3.58172 1156.42 0 1152 0Z" fill="#3F85ED"></path>
            <path d="M56 40C60.4183 40 64 36.4183 64 32C64 27.5817 60.4183 24 56 24C51.5817 24 48 27.5817 48 32C48 36.4183 51.5817 40 56 40Z" fill="#FD873B"></path>
            <path d="M88 40C92.4183 40 96 36.4183 96 32C96 27.5817 92.4183 24 88 24C83.5817 24 80 27.5817 80 32C80 36.4183 83.5817 40 88 40Z" fill="#FFCD8A"></path>
            <path d="M120 40C124.418 40 128 36.4183 128 32C128 27.5817 124.418 24 120 24C115.582 24 112 27.5817 112 32C112 36.4183 115.582 40 120 40Z" fill="#91DD9D"></path>
            <path
            ...
            <path
                ...
                fill="var(--screen-c-2)"
            ></path>
            <path d="M1015.7 672.14V444.023" stroke="var(--screen-c-4)" strokeWidth="8.88047" strokeLinecap="round"></path>
            <path d="M817.559 672.14V444.023" stroke="var(--screen-c-4)" strokeWidth="8.88047" strokeLinecap="round"></path>
            <path d="M619.413 672.14V444.023" stroke="var(--screen-c-4)" strokeWidth="8.88047" strokeLinecap="round"></path>
            <path d="M421.268 672.14V444.023" stroke="var(--screen-c-4)" strokeWidth="8.88047" strokeLinecap="round"></path>
            <path
