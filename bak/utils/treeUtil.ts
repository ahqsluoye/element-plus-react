...
export function flattenTreeData<TreeDataType extends BasicDataNode = DataNode>(
    ...
    function dig(list: TreeDataType[], parent: FlattenNode<TreeDataType> = null): FlattenNode<TreeDataType>[] {
        return list.map((treeNode, index) => {
            ...
            const flattenNode: FlattenNode<TreeDataType> = Object.assign(omit(treeNode, [...fieldTitles, fieldKey, fieldChildren] as any), {
                title: mergedTitle,
                key: mergedKey,
                parent,
                pos,
...
export function traverseDataNodes(
    dataNodes: DataNode[],
    callback: (data: { node: DataNode; index: number; pos: string; key: Key; parentPos: string | number; level: number; nodes: DataNode[] }) => void,
    ...
    // Process
    function processNode(node: DataNode, index?: number, parent?: { node: DataNode; pos: string; level: number }, pathNodes?: DataNode[]) {
...
export function convertNodePropsToEventData<TreeDataType extends BasicDataNode = DataNode>(props: TreeNodeProps<TreeDataType>): EventDataNode<TreeDataType> {
