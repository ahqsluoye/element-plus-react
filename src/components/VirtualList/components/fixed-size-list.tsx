...
const FixedSizeList = buildList({
    ...
    getStopIndexForStartIndex: ({ height, total, itemSize, layout, width }: Props, startIndex: number, scrollOffset: number) => {
...
export type FixedSizeListInstance = React.ElementRef<typeof FixedSizeList> & unknown;
