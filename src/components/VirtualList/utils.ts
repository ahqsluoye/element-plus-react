import { BACKWARD, FORWARD, HORIZONTAL, LTR, RTL, RTL_OFFSET_NAG, RTL_OFFSET_POS_ASC, RTL_OFFSET_POS_DESC } from './defaults';

import type { CSSProperties } from 'react';
import type { Direction, RTLOffsetType } from './types';

export const getScrollDir = (prev: number, cur: number) => (prev < cur ? FORWARD : BACKWARD);

export const isHorizontal = (dir: string) => dir === LTR || dir === RTL || dir === HORIZONTAL;
