 ...
 */
export type CellRenderer<T> = (params: CellRendererParams<T>) => ReactNode;

export type HeaderCellRenderer<T> = (params: HeaderCellRendererParams<T>) => ReactNode;
...
export type CustomizedCellsType = ReactNode[];

export type DefaultCellsType = ReactNode[][];
...
export type SimpleFunctionalComponent<E extends object = { [key: string]: any }> = ComponentType<SimpleFunctionalComponentProps<E>>;
