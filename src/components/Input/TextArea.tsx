...
const TextArea = memo(({ ref, ...props }: TextareaProps & { ref?: React.Ref<TextareaRef | null> }) => {
    ...
    const { name, title, placeholder, readOnly, plain, rows, classPrefix = 'textarea', onFocus, onBlur, onChange, maxLength, showWordLimit, resize, inputStyle, ...rest } = props;
