...
import React, { Component, forwardRef, Ref, useMemo } from 'react';
...
function InternalTree<RecordType extends object = DataNode>(props: TreeProps<RecordType>, ref: Ref<RcTree>) {
    const { prefixCls = 'r-tree', className, showIcon, showLine, switcherIcon, blockNode, children, checkable, selectable, draggable } = props;
    const newProps = {
        ...props,
