...
import { AllowDrop, TreeProps } from './RCTree';
import TreeNode, { TreeNodeProps } from './TreeNode';
import { BasicDataNode, DataEntity, DataNode, Direction, FlattenNode, Key, NodeElement, NodeInstance } from './typings';

export interface Option {
    keepEmpty?: boolean;
}

export function toArray(children: ComponentChildren, option: Option = {}): React.ReactElement[] {
...
export function getDragChildrenKeys<TreeDataType extends BasicDataNode = DataNode>(dragNodeKey: Key, keyEntities: Record<Key, DataEntity<TreeDataType>>): Key[] {
    // not contains self
