...
export class FormStore {
    ...
    private getFieldsValue = (nameList?: NamePath[] | true, filterFunc?: (meta: Meta) => boolean) => {
        ...
        const fieldEntities = this.getFieldEntitiesForNamePathList(Array.isArray(nameList) ? nameList : null);
    ...
    // =========================== Validate ===========================
    private validateFields: InternalValidateFields = (nameList?: NamePath[], options?: ValidateOptions) => {
        this.warningUnhooked();
        ...
        this.getFieldEntities(true).forEach((field: FieldEntity) => {
            ...
            if (!provideNameList || containsNamePath(namePathList, fieldNamePath)) {
                const promise = field.validateRules({
                    ...
                    label: typeof field?.props?.label === 'string' ? field.props.label : '',
                    ...options,
                });
